...
# END
# Thread para mejorar la velocidad de tools. Se usarán un par de threads para reducir costes temporales. (Aumentarán espaciales)
"""class Thread(QtCore.QThread):
	
	def __init__(self,url,dataStruct):
